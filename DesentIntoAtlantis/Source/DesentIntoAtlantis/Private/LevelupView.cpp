...
void ULevelupView::SetupLevelupView(FPlayerCombatEntity* aPlayerCombatEntity)
{
	...
	BW_CharacterPortrait->SetBrushFromTexture(aPlayerCombatEntity->fullBodyCharacterPortrait);
