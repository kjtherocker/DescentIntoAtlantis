...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent_Statics::NewProp_aEventPosition = { "aEventPosition", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(EventManagerSubSystem_eventPlayerHasTriggeredFloorEvent_Parms, aEventPosition), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEventManagerSubSystem, nullptr, "PlayerHasTriggeredFloorEvent", nullptr, nullptr, sizeof(Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent_Statics::EventManagerSubSystem_eventPlayerHasTriggeredFloorEvent_Parms), Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::NewProp_aFloorEventStates_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::NewProp_aFloorEventStates = { "aFloorEventStates", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(EventManagerSubSystem_eventTriggerNextFloorEventStep_Parms, aFloorEventStates), Z_Construct_UEnum_DesentIntoAtlantis_EFloorEventStates, METADATA_PARAMS(nullptr, 0) }; // 2766553892
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEventManagerSubSystem, nullptr, "TriggerNextFloorEventStep", nullptr, nullptr, sizeof(Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::EventManagerSubSystem_eventTriggerNextFloorEventStep_Parms), Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UClass_UEventManagerSubSystem_Statics
	{
		...
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_currentFloor_Underlying;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UEventManagerSubSystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UEventManagerSubSystem_PlayerHasTriggeredFloorEvent, "PlayerHasTriggeredFloorEvent" }, // 98635409
		{ &Z_Construct_UFunction_UEventManagerSubSystem_TriggerNextFloorEventStep, "TriggerNextFloorEventStep" }, // 1330181080
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_isEventRunning = { "isEventRunning", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UEventManagerSubSystem), &Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_isEventRunning_SetBit, METADATA_PARAMS(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_isEventRunning_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_isEventRunning_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_completedFloorEventData_Inner = { "completedFloorEventData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FFloorEventData, METADATA_PARAMS(nullptr, 0) }; // 847672033
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_completedFloorEventData = { "completedFloorEventData", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEventManagerSubSystem, completedFloorEventData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_completedFloorEventData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_completedFloorEventData_MetaData)) }; // 847672033
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_floorEnemyEvents_Key_KeyProp = { "floorEnemyEvents_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_floorEnemyEvents = { "floorEnemyEvents", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEventManagerSubSystem, floorEnemyEvents), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_floorEnemyEvents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_floorEnemyEvents_MetaData)) };
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_currentFloor_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_currentFloor = { "currentFloor", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEventManagerSubSystem, currentFloor), Z_Construct_UEnum_DesentIntoAtlantis_EFloorIdentifier, METADATA_PARAMS(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_currentFloor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_currentFloor_MetaData)) }; // 3166737195
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_gameMode_MetaData[] = {
		{ "ModuleRelativePath", "Public/EventManagerSubSystem.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_gameMode = { "gameMode", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEventManagerSubSystem, gameMode), Z_Construct_UClass_AAtlantisGameModeBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_gameMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEventManagerSubSystem_Statics::NewProp_gameMode_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEventManagerSubSystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UEventManagerSubSystem_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UEventManagerSubSystem_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EventManagerSubSystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EventManagerSubSystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEventManagerSubSystem, UEventManagerSubSystem::StaticClass, TEXT("UEventManagerSubSystem"), &Z_Registration_Info_UClass_UEventManagerSubSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEventManagerSubSystem), 2750885079U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EventManagerSubSystem_h_1531275641(TEXT("/Script/DesentIntoAtlantis"),
		Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EventManagerSubSystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EventManagerSubSystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
