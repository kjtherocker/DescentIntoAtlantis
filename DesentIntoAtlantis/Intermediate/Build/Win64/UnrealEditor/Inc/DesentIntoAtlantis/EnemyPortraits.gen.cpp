...
#include "DesentIntoAtlantis/Public/EnemyPortraits.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEnemyPortraits() {}
// Cross Module References
	DESENTINTOATLANTIS_API UClass* Z_Construct_UClass_UEnemyPortraits_NoRegister();
	DESENTINTOATLANTIS_API UClass* Z_Construct_UClass_UEnemyPortraits();
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UEnemyPortraits);
	UClass* Z_Construct_UClass_UEnemyPortraits_NoRegister()
	{
		return UEnemyPortraits::StaticClass();
	}
	struct Z_Construct_UClass_UEnemyPortraits_Statics
	{
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BW_Portrait1_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_BW_Portrait1;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BW_Portrait2_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_BW_Portrait2;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BW_Portrait3_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_BW_Portrait3;
	...
	UObject* (*const Z_Construct_UClass_UEnemyPortraits_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UBaseUserWidget,
		(UObject* (*)())Z_Construct_UPackage__Script_DesentIntoAtlantis,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyPortraits_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "EnemyPortraits.h" },
		{ "ModuleRelativePath", "Public/EnemyPortraits.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait1_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "EnemyPortraits" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/EnemyPortraits.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait1 = { "BW_Portrait1", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyPortraits, BW_Portrait1), Z_Construct_UClass_UEnemyPortraitElement_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait1_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait1_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait2_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "EnemyPortraits" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/EnemyPortraits.h" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait2 = { "BW_Portrait2", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyPortraits, BW_Portrait2), Z_Construct_UClass_UEnemyPortraitElement_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait2_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait2_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait3_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "EnemyPortraits" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/EnemyPortraits.h" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait3 = { "BW_Portrait3", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyPortraits, BW_Portrait3), Z_Construct_UClass_UEnemyPortraitElement_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait3_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_BW_Portrait3_MetaData)) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyPortraits_Statics::NewProp_enemysInCombat_MetaData[] = {
		{ "ModuleRelativePath", "Public/EnemyPortraits.h" },
	};
#endif
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UEnemyPortraits_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UEnemyPortraits>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEnemyPortraits_Statics::ClassParams = {
		&UEnemyPortraits::StaticClass,
		nullptr,
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UEnemyPortraits_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyPortraits_Statics::PropPointers),
		0,
		0x00B010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UEnemyPortraits_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyPortraits_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UEnemyPortraits()
	{
		if (!Z_Registration_Info_UClass_UEnemyPortraits.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UEnemyPortraits.OuterSingleton, Z_Construct_UClass_UEnemyPortraits_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UEnemyPortraits.OuterSingleton;
	}
	template<> DESENTINTOATLANTIS_API UClass* StaticClass<UEnemyPortraits>()
	{
		return UEnemyPortraits::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UEnemyPortraits);
	struct Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyPortraits_h_Statics
	{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyPortraits_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnemyPortraits, UEnemyPortraits::StaticClass, TEXT("UEnemyPortraits"), &Z_Registration_Info_UClass_UEnemyPortraits, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnemyPortraits), 1190737077U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyPortraits_h_3890533108(TEXT("/Script/DesentIntoAtlantis"),
