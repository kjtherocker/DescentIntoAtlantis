...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_PreviousClassText = { "BW_PreviousClassText", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelupPanelElement, BW_PreviousClassText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_PreviousClassText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_PreviousClassText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_NextClassText = { "BW_NextClassText", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelupPanelElement, BW_NextClassText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_NextClassText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_NextClassText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_AbilityModifierName = { "BW_AbilityModifierName", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelupPanelElement, BW_AbilityModifierName), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_AbilityModifierName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelupPanelElement_Statics::NewProp_BW_AbilityModifierName_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULevelupPanelElement_Statics::ClassParams = {
		...
		0,
		0x00B010A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULevelupPanelElement_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelupPanelElement_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_LevelupPanelElement_h_Statics
	{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_LevelupPanelElement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelupPanelElement, ULevelupPanelElement::StaticClass, TEXT("ULevelupPanelElement"), &Z_Registration_Info_UClass_ULevelupPanelElement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelupPanelElement), 1308021176U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_LevelupPanelElement_h_1610957537(TEXT("/Script/DesentIntoAtlantis"),
