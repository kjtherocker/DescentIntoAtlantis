...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_currentSkill;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCombatSelectionView_Statics::NewProp_currentSkill = { "currentSkill", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCombatSelectionView, currentSkill), Z_Construct_UScriptStruct_FSkills_Base, METADATA_PARAMS(Z_Construct_UClass_UCombatSelectionView_Statics::NewProp_currentSkill_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCombatSelectionView_Statics::NewProp_currentSkill_MetaData)) }; // 102523599
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_CombatSelectionView_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCombatSelectionView, UCombatSelectionView::StaticClass, TEXT("UCombatSelectionView"), &Z_Registration_Info_UClass_UCombatSelectionView, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombatSelectionView), 888104919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_CombatSelectionView_h_3452691320(TEXT("/Script/DesentIntoAtlantis"),
