...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyPortraitElement_Statics::NewProp_BW_HorizontalBox_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "EnemyPortraitElement" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/EnemyPortraitElement.h" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEnemyPortraitElement_Statics::NewProp_BW_HorizontalBox = { "BW_HorizontalBox", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyPortraitElement, BW_HorizontalBox), Z_Construct_UClass_UHorizontalBox_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEnemyPortraitElement_Statics::NewProp_BW_HorizontalBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyPortraitElement_Statics::NewProp_BW_HorizontalBox_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UEnemyPortraitElement_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyPortraitElement_Statics::NewProp_BW_HorizontalBox,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyPortraitElement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnemyPortraitElement, UEnemyPortraitElement::StaticClass, TEXT("UEnemyPortraitElement"), &Z_Registration_Info_UClass_UEnemyPortraitElement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnemyPortraitElement), 4058586615U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyPortraitElement_h_723170907(TEXT("/Script/DesentIntoAtlantis"),
