...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AInGameHUD_Statics::NewProp_persistentViewStack = { "persistentViewStack", nullptr, (EPropertyFlags)0x0010008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AInGameHUD, persistentViewStack), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AInGameHUD_Statics::NewProp_persistentViewStack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AInGameHUD_Statics::NewProp_persistentViewStack_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AInGameHUD_Statics::NewProp_activeViewStack = { "activeViewStack", nullptr, (EPropertyFlags)0x0010008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AInGameHUD, activeViewStack), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AInGameHUD_Statics::NewProp_activeViewStack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AInGameHUD_Statics::NewProp_activeViewStack_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AInGameHUD_Statics::NewProp_inactiveViewStack = { "inactiveViewStack", nullptr, (EPropertyFlags)0x0010008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AInGameHUD, inactiveViewStack), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AInGameHUD_Statics::NewProp_inactiveViewStack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AInGameHUD_Statics::NewProp_inactiveViewStack_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_InGameHUD_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AInGameHUD, AInGameHUD::StaticClass, TEXT("AInGameHUD"), &Z_Registration_Info_UClass_AInGameHUD, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AInGameHUD), 534834114U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_InGameHUD_h_2230550382(TEXT("/Script/DesentIntoAtlantis"),
