...
public:
	...
	UFUNCTION()
	virtual void CheckGenericTriggerPassives(UCombatEntity* WhoTriggeredEvent,EGenericTrigger aPassiveTrigger);
	...
	virtual void AddPassive(EPassiveSkillID passiveSkillID,EPassiveSkillSlotType passiveSkillSlot);
