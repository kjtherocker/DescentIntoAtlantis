...
void USaveView::SpawnSaveSlots(USaveGameData* aSaveGameData, FString aSlotName)
{
...
{
	SaveManagerSubsystem->SaveGameInSlot(SaveSlots[cursorPosition]->saveSlotName);
}

void USaveView::ReSetupSaveFilesInRange(int aMin, int aMax)
{
...
void USaveView::SetDefaultMenuState()
{
	minshownSaves = 0;
	maxshownSaves = 2;
...
void USaveView::SetCursorPositionInfo()
{
	cursorPosition    =  0;
	minCursorPosition =  0;
