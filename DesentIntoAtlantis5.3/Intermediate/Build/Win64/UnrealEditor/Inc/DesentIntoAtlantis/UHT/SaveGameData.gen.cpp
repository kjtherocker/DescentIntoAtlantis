...
// End Cross Module References
	...
	{
		P_GET_OBJECT(UEnemyBestiaryData,Z_Param_aCompleteFloorPawn);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateEnemyBestiaryData(Z_Param_aCompleteFloorPawn);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_USaveGameData_UpdateEnemyBestiaryData_Statics
	{
		...
		{
			UEnemyBestiaryData* aCompleteFloorPawn;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_aCompleteFloorPawn;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USaveGameData_UpdateEnemyBestiaryData_Statics::NewProp_aCompleteFloorPawn = { "aCompleteFloorPawn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SaveGameData_eventUpdateEnemyBestiaryData_Parms, aCompleteFloorPawn), Z_Construct_UClass_UEnemyBestiaryData_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USaveGameData_UpdateEnemyBestiaryData_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USaveGameData_UpdateEnemyBestiaryData_Statics::NewProp_aCompleteFloorPawn,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USaveGameData_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USaveGameData_UpdateEnemyBestiaryData, "UpdateEnemyBestiaryData" }, // 2540334405
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData_ValueProp = { "enemyBestiaryData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FEnemyBestiary, METADATA_PARAMS(0, nullptr) }; // 3905945748
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData_Key_KeyProp = { "enemyBestiaryData_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData_MetaData[] = {
		{ "ModuleRelativePath", "Public/SaveGameData.h" },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData = { "enemyBestiaryData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USaveGameData, enemyBestiaryData), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData_MetaData), Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData_MetaData) }; // 3905945748
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USaveGameData_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USaveGameData_Statics::NewProp_enemyBestiaryData_Key_KeyProp,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis5_3_Source_DesentIntoAtlantis_Public_SaveGameData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USaveGameData, USaveGameData::StaticClass, TEXT("USaveGameData"), &Z_Registration_Info_UClass_USaveGameData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USaveGameData), 2535650070U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis5_3_Source_DesentIntoAtlantis_Public_SaveGameData_h_3691897625(TEXT("/Script/DesentIntoAtlantis"),
