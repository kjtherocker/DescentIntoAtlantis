...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPartyHealthbarsView_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UPartyHealthbarsView_Statics::NewProp_BW_HorizontalBox = { "BW_HorizontalBox", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPartyHealthbarsView, BW_HorizontalBox), Z_Construct_UClass_UHorizontalBox_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPartyHealthbarsView_Statics::NewProp_BW_HorizontalBox_MetaData), Z_Construct_UClass_UPartyHealthbarsView_Statics::NewProp_BW_HorizontalBox_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPartyHealthbarsView_Statics::ClassParams = {
		...
		0,
		0x00B010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPartyHealthbarsView_Statics::Class_MetaDataParams), Z_Construct_UClass_UPartyHealthbarsView_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPartyHealthbarsView_Statics::PropPointers) < 2048);
	...
	UPartyHealthbarsView::UPartyHealthbarsView(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UPartyHealthbarsView);
	UPartyHealthbarsView::~UPartyHealthbarsView() {}
	struct Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_PartyHealthbarsView_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_PartyHealthbarsView_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPartyHealthbarsView, UPartyHealthbarsView::StaticClass, TEXT("UPartyHealthbarsView"), &Z_Registration_Info_UClass_UPartyHealthbarsView, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPartyHealthbarsView), 2295937551U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_PartyHealthbarsView_h_2987571306(TEXT("/Script/DesentIntoAtlantis"),
		Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_PartyHealthbarsView_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_PartyHealthbarsView_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
