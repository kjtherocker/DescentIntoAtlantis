...
template<> DESENTINTOATLANTIS_API UScriptStruct* StaticStruct<FCompleteProgressionData>()
{
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCompleteProgressionData_Statics::NewProp_mapProgression_Key_KeyProp = { "mapProgression_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UEnum_DesentIntoAtlantis_EFloorIdentifier, METADATA_PARAMS(0, nullptr) }; // 1497107215
#if WITH_METADATA
...
void FMapHasChanged_DelegateWrapper(const FMulticastScriptDelegate& MapHasChanged, FCompleteProgressionData playerFacingDirection)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis5_3_Source_DesentIntoAtlantis_Public_LevelProgressionSubsystem_h_Statics::ScriptStructInfo[] = {
		...
		{ FCompleteProgressionData::StaticStruct, Z_Construct_UScriptStruct_FCompleteProgressionData_Statics::NewStructOps, TEXT("CompleteProgressionData"), &Z_Registration_Info_UScriptStruct_CompleteProgressionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCompleteProgressionData), 3155567628U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis5_3_Source_DesentIntoAtlantis_Public_LevelProgressionSubsystem_h_1514934181(TEXT("/Script/DesentIntoAtlantis"),
