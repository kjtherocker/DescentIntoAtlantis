...
void FActivateEnemyBehavior_DelegateWrapper(const FMulticastScriptDelegate& ActivateEnemyBehavior, FCompleteFloorPawnData floorData)
{
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloor_EnemyPawn_Statics::NewProp_hasBeenInitialized_MetaData[] = {
		{ "Category", "Floor_EnemyPawn" },
		{ "ModuleRelativePath", "Public/Floor_EnemyPawn.h" },
	};
#endif
	void Z_Construct_UClass_AFloor_EnemyPawn_Statics::NewProp_hasBeenInitialized_SetBit(void* Obj)
	{
		((AFloor_EnemyPawn*)Obj)->hasBeenInitialized = 1;
	}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis5_3_Source_DesentIntoAtlantis_Public_Floor_EnemyPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFloor_EnemyPawn, AFloor_EnemyPawn::StaticClass, TEXT("AFloor_EnemyPawn"), &Z_Registration_Info_UClass_AFloor_EnemyPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFloor_EnemyPawn), 39140923U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis5_3_Source_DesentIntoAtlantis_Public_Floor_EnemyPawn_h_149403187(TEXT("/Script/DesentIntoAtlantis"),
