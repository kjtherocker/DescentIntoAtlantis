...
// End Cross Module References
	...
	static UEnum* EElementalType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EElementalType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_DesentIntoAtlantis_EElementalType, (UObject*)Z_Construct_UPackage__Script_DesentIntoAtlantis(), TEXT("EElementalType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DesentIntoAtlantis_EElementalType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DesentIntoAtlantis_EElementalType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DesentIntoAtlantis_EElementalType_Statics::Enum_MetaDataParams)
	};
	...
	static UEnum* PressTurnReactions_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_PressTurnReactions.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_DesentIntoAtlantis_PressTurnReactions, (UObject*)Z_Construct_UPackage__Script_DesentIntoAtlantis(), TEXT("PressTurnReactions"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DesentIntoAtlantis_PressTurnReactions_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DesentIntoAtlantis_PressTurnReactions_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DesentIntoAtlantis_PressTurnReactions_Statics::Enum_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_EElementalType_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_EElementalType_h_Statics::EnumInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_EElementalType_h_234294681(TEXT("/Script/DesentIntoAtlantis"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_EElementalType_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_kylej_Desktop_DescentIntoAtlantis_DesentIntoAtlantis_5_1_5_2_5_3_Source_DesentIntoAtlantis_Public_EElementalType_h_Statics::EnumInfo));
